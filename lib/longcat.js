...
class LongCat {
  ...
  update(dt) {
    ...
    const head_transform = this.head_base_transform + ` translateX(${head_x}%) rotateZ(${head_deg}deg)`;
  ...
  meow() { document.getElementById('meow1').play(); }
  slowmeow() { document.getElementById('slowmeow').play(); }
}
